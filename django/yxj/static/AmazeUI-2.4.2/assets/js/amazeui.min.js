...
!function (t, e) {
    ...
    return function (t) {
        ...
        s.VERSION = "2.5.1", s.support = {}, s.support.transition = function () {
            var t = function () {
        ...
        c.DEFAULTS = {
            ...
            var t = this.options, e = this, i = this.$element, n = i.find(".am-modal-prompt-input"),
                o = i.find("[data-am-modal-confirm]"), a = i.find("[data-am-modal-cancel]"), r = function () {
                    var t = [];
