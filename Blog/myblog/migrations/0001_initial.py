# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-11-12 11:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(null=True, upload_to='', verbose_name='文章封面图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40, null=True, verbose_name='标签云')),
            ],
            options={
                'verbose_name': '标签云',
            },
